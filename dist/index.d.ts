...
type Method = BaseMethodProperties & {
    entrypoint: Exclude<string, "approve">;
};
type Approval = BaseMethodProperties & {
    entrypoint: "approve";
    /**
...
export { type AgeGateOptions, type AppleAppSiteAssociation, type Approval, type BaseMethodProperties, type CallPolicy, type ChainId, type Chains, type ColorMode, type ContractPolicies, type ContractPolicy, type ControllerColor, type ControllerColors, type ControllerConfig, type ControllerConfigs, type ControllerTheme, type EkuboERC20Metadata, type LocationGateOptions, type Method, type OptimizedImageSet, type Policies, type Policy, type PolicyPredicate, type SessionPolicies, type SignMessagePolicy, type ThemeValue, type TypedDataPolicy, defaultTheme, erc20Metadata, getAvailableConfigs, getConfigsIndex, loadAllConfigs, loadConfig };
